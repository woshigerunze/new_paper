...
生成对应的C++文件。自定义.proto文件如图\ref{test_proto}所示。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.45\textwidth]{test_proto.png}
  \caption{.proto文件数据字段}
  \label{test_proto}
\end{figure}
运行脚本后，得到中间语言中的.h头文件、.cpp实现文件和中间语言对应的静态库.a文件，如图\ref{test_lib_symbol}和图\ref{test_middle_languange}所示。
\begin{figure}[H]
  \centering
