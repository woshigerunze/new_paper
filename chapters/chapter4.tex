...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{subscriber_gaiyao_timesequence.png}
  \caption{创建订阅者时序图}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{message_tick_gaiyao.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{time_tick_gaiyao.png}
